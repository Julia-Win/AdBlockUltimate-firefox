...
ContentScripts.prototype = {
    ...
    init: function (contentMessageHandler) {
        ...
        this.registerChromeContentScript('chrome://adblockultimate/content/filter-download.html*', [
...
/*
        // Thankyou.html
        this.registerChromeContentScript('chrome://adblockultimate/content/thankyou.html*', [
            'content/libs/jquery-1.8.3.min.js',
            'content/content-script/content-script.js',
            'content/content-script/i18n-helper.js',
            'content/pages/i18n.js',
...
*/
        // Options.html
        this.registerChromeContentScript('chrome://adblockultimate/content/options.html*', [
            'content/libs/jquery-1.8.3.min.js',
        ...
        // Log.html
        this.registerChromeContentScript('chrome://adblockultimate/content/log.html*', [
            'content/libs/jquery-1.8.3.min.js',
            'content/libs/bootstrap.min.js',
            'content/libs/moment-with-locales.min.js',
            'content/content-script/content-script.js',
        ...
        // Export.html
        this.registerChromeContentScript('chrome://adblockultimate/content/export.html*', [
            'content/libs/jquery-1.8.3.min.js',
            'content/content-script/content-script.js',
...
/*
        // Sb.html
        this.registerChromeContentScript('chrome://adblockultimate/content/sb.html*', [
            'content/libs/jquery-1.8.3.min.js',
            'content/content-script/content-script.js',
            'content/content-script/i18n-helper.js',
            'content/pages/i18n.js',
